...
import { UserRegisterDto } from 'apps/api-gateway/src/dtos/account/user-register.dto';
...
export class AuthController {
  ...
  async createAdmin(@Payload() data: UserRegisterDto): Promise<UserRegisterResponse> {
